...
def test_test_cnn(mocker, test_cnn_config):
    ...
    mock_test_predictions_class = mocker.patch("cleave_app.commands.test_commands.TestPredictions")
    ...
    mock_log_run = mocker.patch("cleave_app.commands.test_commands.log_classifier_test_results")
    mock_test_predictions_instance.display_confusion_matrix.return_value = "confusion.png"
    mock_test_predictions_instance.display_classification_report.return_value = None
